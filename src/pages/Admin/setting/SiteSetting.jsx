...
const SiteSetting = () => {
  ...
  return (
    <div
      className={`flex-1 overflow-y-auto p-4 md:p-6 transition-colors duration-300 ${theme.main}`}
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* Tab Content Area */}
        <div
          className={`rounded-xl border shadow-sm overflow-hidden transition-all duration-300 ${theme.card}`}
        >
          <div className="p-6">
